let jokes_array= [`Q: Why did the cell phone get glasses?‍

A: Because she lost all her contacts.`,

`Q: How did the mobile phone propose to his girlfrien
...
`Q: Why did the Oreo go to the dentis
...
`Q: Why did the computer do to the docto
...
`Q: Why did Johnny throw the clock out of the windo
...
button.addEventListener('click', function() {
    let random = getRandomInt(len-1);

    console.log(jokes_array[random]);
    jokebox.innerText = jokes_array[random];
